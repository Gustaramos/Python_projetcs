class ExtratorURL:
    ...
    def valida_url(self):
        ...
        if not self.url.startswith('https') or not self.get_url_base().endswith('/cambio'):
...
extrator_url = ExtratorURL('https://bytbank.com/cambio?moedaDestino=dolar&quantidade=100&moedaOrigem=real')
